<?php
	...
	if(isset($_POST['warehouse_id'])) {
		...
		if(partial_access('admin') || $warehouse_access->have_warehouse_access()){} else { unset($_SESSION['warehouse_id']); }
                    ...
                    <div id="main-wrapper">
                        ...
                        <div class="row">
							<div class="col-lg-3 col-md-3">
								...
								<?php } else { ?>
								<a style="display:block" href="warehouse.php?s_s=<?php echo session_id(); ?>">
									<div class="panel warh-bloc" style="background-color:#2BBBAD;opacity:0.8">
										<div class="panel-body" >
											
											<div class="pull-left">
												
												<p class="stats-info title-warh-bloc">Warehouse</p>
											</div>
											<div class="pull-right icon-warh-bloc">
