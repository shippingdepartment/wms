...
$page_title = 'Send Inventory';

if (isset($_POST['save'])) {
    extract($_POST);
    $message =  $important->sendInventoryFromStore($sku, $tracking, intval($quantity));
                        ...
                        <div class="panel-body">
                            <form action="<?php $_SERVER['PHP_SELF'] ?>" class="form-horizontal" method='POST' name='testform'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="tracking" id="tracking" class="form-control" placeholder="Enter Tracking" />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="well">
                                            <center>
                                                <Button type="submit" class="btn btn-info btn-addon" name="save" value="Save"> <i class="fa fa-save"></i> Send Inventory </Button>
                                            </center>
                                        </div>
                                    </div>
