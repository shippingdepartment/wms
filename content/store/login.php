...
if (isset($_POST['login']) && $_POST['login'] == 1) {
    ...
    if ($message == 1) {
        ...
        $_SESSION['is_request'] = $new_user?->is_request ?? false;
...
<head>
    ...
    <!-- Javascripts -->
    <script defer src="../../assets/plugins/jquery/jquery-3.1.0.min.js"></script>
                    ...
                    <div class="col-sm-6 col-md-3 login-box">
                        ...
                        <form action="<?php $_SERVER['PHP_SELF'] ?>" id="login_form" name="login" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="submit" class="form-control" style="background-color:#0d47a1;color:#FFF"
                                    value="Login" />
                            </div>
