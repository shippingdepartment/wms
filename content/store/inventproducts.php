					...
					<div class="col-md-12">
						<div class="panel panel-white alert alert-default">
							...
							<div class="panel-body">
								<a href="reports/printinventory.php" target="_blank" class="btn btn-info btn-addon"> <i class="fa fa-print"></i> Print Inventory</a>

								<a class="btn btn-info btn-addon" onClick="$('#example3').tableExport({type:'excel',mso:{fileFormat:'csv',}});"> <i class="fa fa-file-excel-o"></i> Export to CSV</a>
