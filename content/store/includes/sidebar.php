        ...
        <div class="page-sidebar-menu">
            <ul class="accordion-menu">
                ...
                <?php if (partial_access('admin')) { ?>
                    <li>
                        <a href="javascript:void(0)">
                            <i class="menu-icon icon-users"></i><span>Users</span><i
                ...
                <?php if (partial_access('admin')) { ?>
                    ...
                    <li>
                        <a href="javascript:void(0)">
                            <i class="menu-icon fa fa-barcode"></i><span>Products <i
                                    class="accordion-icon fa fa-angle-right"></i></span>
                        </a>
                        <ul class="sub-menu">
                            <li><a href="products.php"><span class="text-success"><i class="fa fa-caret-right"></i>
                                        Products</span></a></li>
                            <li><a href="categories.php"><span class="text-success"><i class="fa fa-caret-right"></i>
                                        Categories</span></a></li>
                            <?php if (partial_access('admin') or $function_id == 'storem' or $function_id == 'manager') { ?>
                                <li><a href="dimensions.php"><span class="text-success"><i class="fa fa-caret-right"></i>
                                            Product Settings</span></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                <?php } ?>
                <li>
                    <a href="javascript:void(0)">
                        <i class="menu-icon fa fa-credit-card"></i><span>Orders <i
                                class="accordion-icon fa fa-angle-right"></i> </span>
                    </a>
                    <ul class="sub-menu">
                        <?php if (partial_access('admin')) { ?>
                            <li><a href="assigned_orders_list.php"><span class="text-success"><i
                                            class="fa fa-caret-right"></i> All Assigned Orders</span></a></li>
                        <?php } ?>
                        <li><a href="assigned_orders_list.php?t=user"><span class="text-success"><i
                                        class="fa fa-caret-right"></i> Assigned Orders</span></a></li>
                        <li><a href="buy_postage.php"><span class="text-success"><i class="fa fa-caret-right"></i> Buy
                                    Postage </span></a></li>
                        <li><a href="finished_orders.php"><span class="text-success"><i class="fa fa-caret-right"></i>
                                    Finished Orders </span></a></li>
                ...
                <li>
                    <a href="javascript:void(0)">
                        <i class="menu-icon fa fa-list-ol"></i><span>Inventory <i
                                class="accordion-icon fa fa-angle-right"></i></span>
                    </a>
                    <ul class="sub-menu">
                        <li><a href="inventproducts.php"><span class="text-success" title="Inventory by Warehouse"><i
                                        class="fa fa-caret-right"></i> Inventory</span></a></li>
                        <li><a href="lowstock.php"><span class="text-success" title="Low Stock"><i
                                        class="fa fa-caret-right"></i> Low Stock </span></a></li>
                        <li><a href="outstock.php"><span class="text-success" title="Low Stock"><i
                                        class="fa fa-caret-right"></i> Out Of Stock </span></a></li>
                        <li><a href="addstock.php"><span class="text-success"><i class="fa fa-caret-right"></i> Add
                                    Stock</span></a></li>
                        <li><a href="updatestock.php"><span class="text-success"><i class="fa fa-caret-right"></i>
                                    Update Stock</span></a></li>
                        <li><a href="receive_shipments.php"><span class="text-success"><i class="fa fa-caret-right"></i>
                                    Receive Shipments</span></a></li>
                        <li><a href="receive_inventory_request.php"><span class="text-success"><i
                                        class="fa fa-caret-right"></i> Received Request</span></a></li>
                ...
                <li>
                    <a href="javascript:void(0)">
                        <i class="menu-icon fa fa-truck"></i><span>Return <i
                                class="accordion-icon fa fa-angle-right"></i> </span>
                    </a>
                    <ul class="sub-menu">
                        <li><a href="return_label_list.php"><span class="text-success"><i class="fa fa-caret-right"></i>
                                    Return labels</span></a></li>
                        <?php if (partial_access('admin') or $function_id == 'storem' or $function_id == 'manager') { ?>
                            <li><a href="newreturn.php"><span class="text-success"><i class="fa fa-caret-right"></i> New
                                        Stock Return</span></a></li>
                        <?php } ?>
                        <li><a href="returns.php"><span class="text-success"><i class="fa fa-caret-right"></i> All
                                    Returns</span></a></li>
                    </ul>
                </li>
