...
if (isset($_POST['save'])) {
    extract($_POST);
    $message = $warehouse->add_inventory('0', $quantity, $product, $_SESSION['warehouse_id'], $lot);
    HEADER('LOCATION: updatestock.php?message=Stock Updated !!');
}
                    ...
                    <div class="panel-heading clearfix">
                        <div class="panel-body">
                            <form class="form-horizontal" action="<?php $_SERVER['PHP_SELF'] ?>" id="wizardForm" name="level" method="post">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Quantity to Subtract :</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <center>
                                        <div class="alert alert-default">
                                            <Button type="submit" class="btn btn-info btn-addon" name="save" /> <i class="fa fa-plus"></i> Subtract Quatity to Stock</Button>
                                    </center>
                                </div>
                        </div>
