<?php
	...
	if(partial_access('admin') || $warehouse_access->have_module_access('suppliers')) {} else { 
		HEADER('LOCATION: warehouse.php?msg=suppliers');
	}
	...
	$page_title = 'Suppliers'; //You can edit this to change your page title.
	
	if(isset($_POST['enable_supplier']))  {
		extract($_POST);
		$message = $supplier->enable_supplier($enable_supplier);
	}
	if(isset($_POST['disable_supplier']))  {
		extract($_POST);
		$message = $supplier->disable_supplier($disable_supplier);
	}
				...
				?>
					...
					<div class="panel-body"  >
						...
						<div style="float:left">
							<a href="newsupplier.php"  class="btn btn-info btn-addon" ><i class="fa fa-plus"></i> Add New Supplier</a>
						</div>
						<div style="float:right">
									<?php } else { ?>
						<div style="float:left">
									<?php } ?>
                                     <a href="reports/listSuppliers.php" target="_blank"  class="btn btn-info btn-addon"  > <i class="fa fa-plus"></i> Print Suppliers List</a>
