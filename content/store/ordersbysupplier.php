<?php
	...
	$page_title = 'Purshasing Orders per Supplier'; //You can edit this to change your page title.
            ...
            <div class="page-content">
				...
				?>
					...
					<div class="alert alert-default" style="font-size:16px;color:#0d47a1" role="alert">
                        <form action="ordersbysupplier.php" class="form-horizontal" method='POST' name='testform'>
							<div class="form-group" >
								<label class="col-sm-3 control-label" style="text-align:center">Choose the Supplier  :	</label>
								<div class="col-sm-8">
									<select name="supplier_id" id="supplier" class="form-control" style="width:100%" onchange="this.form.submit(); " Required >
										<?php if (isset($_POST['supplier_id'])) { ?>
										<option value=""><?php echo $supplier->get_supplier_info($_POST['supplier_id'], 'full_name') ?></option>
										<?php } else { ?>
					...
					<table id="example3" class="display table" style="width: 100%; cellspacing: 0;" >
						...
						<tbody>
						  ...
						  if (isset($_POST['supplier_id'])) {
								$order->list_all_orders_bysupp($_SESSION['warehouse_id'], $_POST['supplier_id']); 
						  }
							?>
						</tbody>
