...
<html>
    ...
    <body>
    	<div id="reportContainer">
        	<table width="100%" cellpadding="10px" border="0px">
            	<tr>
                    ...
                    <td style="text-align:right;">
                    	<h1 style="color:#CCC;">Packing List</h1>
            ...
            <br />
<?php $packing_detail = $delivery->view_packing_invoice($_GET['did']); ?>
...
<div style="clear:both;"></div>
	<table width="100%" cellpadding="5px" cellspacing="0" border="0">
		<tr>
			...
			<td align="right">
				<p style="margin-top:20px;">Name + Signature Driver</p>
			</td>
		</tr>
	</table>
