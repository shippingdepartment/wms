...
<html>
    ...
    <body>
    	<div id="reportContainer">
        	<table width="100%" cellpadding="10px" border="0px" style="font-size:13px">
            	<tr>
                    ...
                    <td style="text-align:right;">
						...
						<?php $approvedby = $transfer->get_transfer_details_info($_GET['tid'], 'agent_id'); ?>
						...
						Approved By: <?php echo $user->get_user_info($approvedby, 'first_name').' '.$user->get_user_info($approvedby, 'last_name'); ?>
                        </p>
            ...
            <br />
<?php $transfer_detail = $transfer->approved_transfer_invoice($_GET['tid']); ?>
