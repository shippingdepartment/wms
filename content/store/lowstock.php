...
$page_title = 'Low Stock'; //You can edit this to change your page title.
					...
					<div class="col-md-12">
						<div class="panel panel-white alert alert-default">
							...
							<div class="panel-body">
								<a href="reports/printlowstock.php" target="_blank" class="btn btn-info btn-addon"> <i class="fa fa-print"></i> Print List </a>
