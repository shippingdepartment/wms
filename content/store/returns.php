<?php
	...
	if(partial_access('admin') || $warehouse_access->have_module_access('deliveries')) {} else { 
		HEADER('LOCATION: warehouse.php?message=lstrtn');
	}
	...
	$page_title = 'List of Returns'; //You can edit this to change your page title.
            ...
            <div class="page-content">
				...
				?>
					...
					<div class="panel-body" >
                                    <a href="reports/printReturns.php" target="_blank" class="btn btn-info btn-addon"  > <i class="fa fa-print"></i> Print Return List</a>
					...
					<table id="example3" class="display table" style="width: 100%; cellspacing: 0;" >
						...
						<tbody>
						   <?php 
								...
								$delivery->list_all_returns($_SESSION['warehouse_id']); 
