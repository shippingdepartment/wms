...
<style type="text/css">
	.pull-left {
        ...
        <div class="pull-left">
            <div class="TopImg">
                <a href="sale.php"><img src="images/3img.png" width="114" height="101" /></a>
            </div><!--TopImg-->
        ...
        <div class="pull-left">
            <div class="TopImg">
                <a href="purchase.php"><img src="images/4img.png" width="111" height="101" /></a>
            </div><!--TopImg-->
                <div class="bottomName">
        ...
        <div class="pull-left">
            <div class="TopImg">
                <a href="vendors.php"><img src="images/5img.png" width="112" height="101" /></a>
            </div><!--TopImg-->
                <div class="bottomName">
        ...
        <div class="pull-left">
            <div class="TopImg">
                <a href="clients.php"><img src="images/6img.png" width="111" height="100" /></a>
            </div><!--TopImg-->
                <div class="bottomName">
        ...
        <div class="pull-left">
            <div class="TopImg">
                <a href="products.php"><img src="images/7img.png" width="112" height="100" /></a>
            </div><!--TopImg-->
                <div class="bottomName">
        ...
        <div class="pull-left">
            <div class="TopImg">
                <a href="warehouse.php"><img src="images/9img.png" width="110" height="100" /></a>
            </div><!--TopImg-->
                <div class="bottomName">
        ...
        <div class="pull-left">
            <div class="TopImg">
                <a href="reports.php"><img src="images/11.png" width="109" height="100" /></a>
            </div><!--TopImg-->
                <div class="bottomName">
        ...
        <div class="pull-left">
            <div class="TopImg">
                <a href="sale_returns.php"><img src="images/13.png" width="113" height="100" /></a>
            </div><!--TopImg-->
                <div class="bottomName">
        ...
        <div class="pull-left">
            <div class="TopImg">
                <a href="set_product_rates.php"><img src="images/pricelevel.png" width="111" height="105" /></a>
            </div><!--TopImg-->
                <div class="bottomName">
        ...
        <div class="pull-left">
            <div class="TopImg">
                <a href="point_of_sale.php"><img src="images/pos-icon.gif" width="111" height="105" /></a>
            </div><!--TopImg-->
                <div class="bottomName">
