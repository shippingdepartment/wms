...
<html>
	<head>
		...
		<style>
			body { 
				background-image: url('../../../assets/images/received.png');
    ...
    <body>
    	<div id="reportContainer">
        	<table width="100%" cellpadding="10px" border="0px">
            	<tr>
                    ...
                    <td style="text-align:right;">
						...
						Status # : <?php echo '<span style="color:00CC00"><b>Received</b></span>'; ?><br />
                        <?php $agent_id = $order->get_order_receive_info($_GET['oid'], 'agent_id');  
						if ( $st=='1' )  { ?>
                        Received By: <?php echo $user->get_user_info($agent_id, 'first_name').' '.$user->get_user_info($agent_id, 'last_name'); ?><br> <?php }?>
						<?php $destination = $order->get_order_info($_GET['oid'], 'warehouse_id'); 
            ...
            <br />
<?php $order_detail = $order->view_order_reception($_GET['oid']); ?>
