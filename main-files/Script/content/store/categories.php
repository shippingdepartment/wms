<?php
	...
	$page_title = 'Categories'; //You can edit this to change your page title.
				...
				?>
					...
					<div class="panel-body"  >
						...
						<div style="float:left">
							<a href="newcategory.php"  class="btn btn-info btn-addon" ><i class="fa fa-plus"></i> Add New Category</a>
						</div>
						<div style="float:right">
									<?php } else { ?>
						<div style="float:left">
									<?php } ?>
                                     <a href="javascript:window.print()"  class="btn btn-info btn-addon"  > <i class="fa fa-plus"></i> Print List of Categories</a>
					...
					<table id="example3" class="display" style="width: 100%; cellspacing: 0;">
						<thead>
							<tr>
								<th>ID</th>
								<th>Name</th>
