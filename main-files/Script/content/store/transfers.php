<?php
	...
	if(isset($_POST['delete_transfer']) && $_POST['delete_transfer'] != '') { 
		$message = $transfer->delete_transfer($_POST['delete_transfer']);
	}//delete account.
	
	$warehouses->set_warehouse($_SESSION['warehouse_id']); //setting store.
	 
	$page_title = 'Transfers'; //You can edit this to change your page title.
            ...
            <div class="page-content">
				...
				?>
					...
					<div class="panel-body" >
                                    <a href="reports/listTransferSent.php" target="_blank"  class="btn btn-info btn-addon"  > <i class="fa fa-plus"></i> Print Transfer List</a>
                    
                                    <a   class="btn btn-info btn-addon" onClick ="$('#example2').tableExport({type:'excel',escape:'false'});" > <i class="fa fa-file-excel-o"></i> Export to CSV</a>
					</div>
					</br>
					<div class="panel-body"   >
					...
					<table id="example2" class="display table" style="width: 100%; cellspacing: 0;" >
						...
						<tbody>
						   <?php 
								...
								$transfer->list_all_transfers($_SESSION['warehouse_id']); 
