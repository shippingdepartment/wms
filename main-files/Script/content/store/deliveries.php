<?php
	...
	if(partial_access('admin') || $warehouse_access->have_module_access('deliveries')) {} else { 
		HEADER('LOCATION: warehouse.php?message=lstdlvr');
	}
	...
	$page_title = 'Deliveries'; //You can edit this to change your page title.
				...
				?>
					...
					<div class="panel-body"  >
						...
						<div style="float:left">
							<a href="newdelivery.php"  class="btn btn-info btn-addon" ><i class="fa fa-plus"></i> Add New Delivery</a>
						</div>
						<div style="float:right">
									<?php } else { ?>
						<div style="float:left">
									<?php } ?>
                                     <a href="reports/listDeliveries.php" target="_blank"  class="btn btn-info btn-addon"  > <i class="fa fa-print"></i> Print Deliveries List</a>
					...
					<table id="example3" class="display table" style="width: 100%; cellspacing: 0;" >
						...
						<tbody>
						   <?php 
								...
								$delivery->list_all_deliveries($_SESSION['warehouse_id']); 
