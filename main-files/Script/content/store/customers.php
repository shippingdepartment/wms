<?php
	...
	$page_title = 'Customers'; //You can edit this to change your page title.
	
	if(isset($_POST['enable_customer']))  {
		extract($_POST);
		$message = $client->enable_customer($enable_customer);
	}
	if(isset($_POST['disable_customer']))  {
		extract($_POST);
		$message = $client->disable_customer($disable_customer);
	}
				...
				?>
					...
					<div class="panel-body"  >
						...
						<div style="float:left">
							<a href="newcustomer.php"  class="btn btn-info btn-addon" ><i class="fa fa-plus"></i> Add New Customer</a>
						</div>
