<?php
	...
	$page_title = 'Received Transfers'; //You can edit this to change your page title.
            ...
            <div class="page-content">
				...
				?>
					...
					<div class="panel-body" >
                                    <a href="reports/listTransferReceived.php" target="_blank"  class="btn btn-info btn-addon"  > <i class="fa fa-plus"></i> Print Transfer List</a>
					...
					<table id="example3" class="display table" style="width: 100%; cellspacing: 0;" >
						...
						<tbody>
						   <?php 
								...
								$transfer->list_all_transfers_received($_SESSION['warehouse_id']); 
